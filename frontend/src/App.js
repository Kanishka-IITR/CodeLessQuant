...
// import MetricsTable from './components/MetricsTable';
// import LivePriceViewer from './components/LivePriceViewer';
// import EquityGraph from './components/EquityGraph'; // Import the graph component
...
//       const { final_balance, starting_balance, sharpe_ratio, total_trades, win_rate, avg_win, avg_loss, max_drawdown, equity_curve } = response.data;
//       setMetrics({ final_balance, starting_balance, sharpe_ratio, total_trades, win_rate, avg_win, avg_loss, max_drawdown });

//       // Ensure the x and y dimensions match for the graph
//       if (equity_curve) {
//         const minLength = Math.min(equity_curve.x.length, equity_curve.y.length);
//         const trimmedEquityCurve = {
//           x: equity_curve.x.slice(0, minLength),
//           y: equity_curve.y.slice(0, minLength),
//         };
//         setResult(prevState => ({ ...prevState, equity_curve: trimmedEquityCurve }));
//       }
...
//           {/* Render the equity graph */}
//           {result.equity_curve && <EquityGraph equityData={result.equity_curve} />}
//         </div>
//       )}
//     </div>
//   );
